      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 order-1 align-self-end">
            <img src="public/assets/images/model_7.png" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="public/assets/images/blog_1.jpg" alt="Image placeholder" class="img-fluid rounded">
        ...
        <div class="row">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="public/assets/images/person_1.jpg" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="public/assets/images/person_2.jpg" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="public/assets/images/person_3.jpg" alt="Image placeholder" class="mb-4">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="public/assets/images/person_4.jpg" alt="Image placeholder" class="mb-4">
